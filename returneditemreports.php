...
<body>
    ...
    <div class="left-bar">
        ...
        <a href="returneditemreports.php">
            <img src = "./images/reports.png" alt="Reports" class="reports"> <span style="color: red;">Reports</span>
        </a>
...
<div class="content">
        <div class="navigation-bar">
            ...
            <a class="active" href="returneditemreports.php">Returned Items</a>
            <a href="disposeditemreports.php">Disposed Items</a>
        </div>
        <h2>RETURNED ITEMS REPORTS</h2>
        ...
        <div class="content-box reports-box" id="returned-items">
        ...
        while ($returnedItem = mysqli_fetch_assoc($returnedItemsResult)) {
            echo "<tr>";
            echo "<td>{$returnedItem['id']}</td>";
            echo "<td>{$returnedItem['returned_item']}</td>";
            echo "<td>{$returnedItem['returned_itemdetails']}</td>";
            echo "<td>{$returnedItem['returnedto']}<br><br>{$returnedItem['owner_address']}<br><br>
            {$returnedItem['owner_course']}</td>";
            echo "<td>{$returnedItem['email']}</td>";
            echo "<td>{$returnedItem['phone']}</td>";
            echo "<td>{$returnedItem['datereturned']}</td>";
            echo "<td><img src='uploads/{$returnedItem['returned_itemimg']}' alt='Found Item Image'></td>";
            echo "<td>{$returnedItem['rnotes']}</td>";
            echo "<td>";
            echo "<button onclick='deleteItem({$returnedItem['id']})'>Delete</button>";
            echo "</td>";
            echo "</tr>";
            echo "</tr>";
        }
...
<script>
  function liveSearch(query) {
    const xhr = new XMLHttpRequest();
    const tableContainer = document.getElementById('returned-items-table');
    ...
    xhr.open("POST", "live_search_returneditem.php", true);
